...
#define OBJECT_TYPE_CASTLE 2
#define OBJECT_TYPE_PUSHTOSTART 3
...
void StartScene::_ParseSection_TEXTURES(string line)
{
...
void StartScene::_ParseSection_SPRITES(string line)
{
	vector<string> tokens = split(line);
...
void StartScene::_ParseSection_ANIMATIONS(string line)
{
	vector<string> tokens = split(line);
...
void StartScene::_ParseSection_ANIMATION_SETS(string line)
{
	vector<string> tokens = split(line);
...
{
	if (KeyCode == DIK_X) {
		CGame::GetInstance()->SwitchScene(20,true);
	}
}
