#include "StairStep2.h"
#include "Utils.h"


StairStep2::StairStep2(float l, float t, float r, float b)
{
	this->x = l;
	this->y = t;
	this->width = r - l + 1;
...
void StairStep2::Render()
{
	RenderBoundingBox();
}

void StairStep2::GetBoundingBox(float & l, float & t, float & r, float & b)
{
	l = x;
	t = y;
	r = x + width;
...
bool StairStep2::GetSimonVertex(float simonX, float simonY, float & vx, float & vy)
{
